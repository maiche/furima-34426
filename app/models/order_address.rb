class OrderAddress
  ...
  attr_accessor :item_id, :user_id,:postal_code, :prefecture_id, :district, :address_code, :building, :telephone
  ...
  with_options presence: true do
    ...
    validates :telephone, format: {with: /\A[0-9]{,11}\z/, message: "is invalid. Input only number"}
  end
